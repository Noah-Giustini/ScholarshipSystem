...
public class Application {
	...
	/**
	 * Constructor. Loads an application for given scholarship and student if the
	 * file exists or generates a new application if a file for that application
	 * does not exist. Names file the student's name followed by the scholarship
	 * name.
	 * 
	...
	public void overWriteLine(String tag, String newtext) throws Exception {
		...
		PrintWriter writer = new PrintWriter(
				new BufferedWriter(new FileWriter(this.scholarship + " " + this.student + ".temp")));
	...
	/**
	 * Create a new file for an application. Names file the given name of the
	 * application and sets basic file format.
	 */
	...
	public String toString() {
		...
		return this.scholarship + ": " + this.student + ", Date Submitted: " + this.date + ", GPA: " + this.gpa
				+ ", Education Level: " + this.edulvl + ", Priority: " + this.priority + ", Status: " + this.status;
	}

	/**
	 * Loads all application files into the applicationList in ScholarshipSystem
	 * class
	 */
	...
	// if(a.isFile()){
	// String name = a.getName().substring(0, (a.getName().length() - 4)); //takes
	// away the .txt

	// String schName = name.substring(0, name.length() - 3); //gets scholarship
	// name
