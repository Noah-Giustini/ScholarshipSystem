...
public class Admin {
     ...
     * 
     * @param allApplications is an ArrayList with type Application that contains
    ...
    public void confirmAward(Scholarship s, Application a) throws Exception {
        ...
        System.out.println("The scholarship " + name + " has been granted to student " + student
     ...
     * @param recipients is the integer number of recipients that the scholarship
     *                   can go out to
     * @param levels     an array list of the levels that can recieve the
     *                   scholarship
     * @return The newly created scholarship is returned as an output
     */
    public Scholarship createScholarship(String name, String dueDate, double amt, int recipients,
            ArrayList<String> levels) throws Exception {

        Scholarship s = new Scholarship(name, true);
     ...
     * 
     * @param s is of type Scholarship and is the scholarship we wish to check the
     *          status of
     * @return status is returned with type boolean. True us returned indicating the
     *         scholarship is closed, false is returned indicating the scholarship
     *         is still pending
     */
