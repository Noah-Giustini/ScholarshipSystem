...
public class Scholarship {
	...
	/**
	 * Constructor. Scholarship constructor that creates a new scholarship object
	 * and file or load an old scholarship if a scholarhip file with the given name
	 * already exists.
	 * 
	...
	public Scholarship(String schname, boolean submit) throws Exception {
		...
		if (this.submit) {
			this.schfile = "ScholarshipSystem" + File.separator + "Scholarships" + File.separator + schname + ".txt";
			
		} else {
			this.schfile =  "ScholarshipSystem" + File.separator + "ScholarshipSaves" + File.separator + schname + ".txt";
		}
	...
	/**
	 * Constructor. Scholarship constructor used when loading in all scholarships to
	 * the ScholarshipSystem.
	 */
	public Scholarship() {
	}
	...
	/**
	 * Changes a line in scholarship file given the name of the parameter that needs
	 * to be changed and the new value for that parameter
	 * 
	...
	private void overWriteLine(String tag, String newtext) throws Exception {
		...
		tmpfile = "ScholarshipSystem" + File.separator + "Scholarships" + File.separator + this.name + ".temp";
	...
	public String toString() {
		...
		return this.name + ", Due: " + this.duedate + ", Amount: " + this.amount + "$, Recipient(s): " + this.recipients
				+ ", Recipient(s) Chosen: " + this.chosen + ", Education Levels: " + EduLvls;
	}
	 ...
	 */
	/**
	 * public static void startUp(){ File folder = new File("Scholarships"); File[]
	 * listOfFiles = folder.listFiles(); for(File a : listOfFiles){ if(a.isFile()){
	 * String name = a.getName().substring(0, (a.getName().length() - 4)); try {
	 * Scholarship sch = new Scholarship(name, true);
	 * 
	 * } catch (Exception e){ } } }
	 */
