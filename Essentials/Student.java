...
public class Student{
    ...
    public void apply(Scholarship scholarship, Scanner scan) {
        try {
        Application app = new Application(scholarship.getName(), this.name, true);
        try {
    ...
    public void withdrawApplication(Application app) {
        ...
        Scholarship sch = new Scholarship(app.getScholarship(),true);
    ...
    public ArrayList<Scholarship> getEligbleScholarships(){
        return Seng300.getScholarships();
    }
